...
const InitFct SPW_Initializers[] = {
    ...
    Class_InitStaticMap, Class_InitBonus, Class_InitBrick,Class_InitBreakableGround, Class_InitMovingPlatform,
    Class_InitCheckpoint, Class_InitLevelEnd,
    Class_InitCollectable, Class_InitFirefly, Class_InitHeart,
    Class_InitEnemy, Class_InitNut, Class_InitMSN, Class_InitDemon,
