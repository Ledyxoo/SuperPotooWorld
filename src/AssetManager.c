...
RE_Atlas* AssetManager_GetDemonAtlas(AssetManager* assets)
{
    GameAtlases* atlases = &assets->m_demon;
    if (!atlases->m_demon)
    {
    ...
    return atlases->m_demon;
}

RE_Atlas* AssetManager_GetMSNAtlas(AssetManager* assets)
{
    GameAtlases* atlases = &assets->m_MSN;
    if (!atlases->m_MSN)
    {
