...
void LevelHeader_Constructor(void* self, void* scene)
{
    ...
    Image_Constructor(lifeImg, scene, Lpart, 1);
    rect.m_anchorMin = Vec2_Set(0.0f, 0.0f);
    rect.m_anchorMax = Vec2_Set(0.0f, 0.0f);
    rect.m_offsetMin = Vec2_Set(0.0f, 100.0f);
    rect.m_offsetMax = Vec2_Set(80.0f, 180.0f);
    UIObject_SetLocalRect(lifeImg, rect);
    GameObject_SetParent(lifeImg, panel);

    // Compteur du nombre de Life
    ...
    Image_Constructor(heartImg, scene, hpart, 2);
    rect.m_anchorMin = Vec2_Set(0.0f, 0.0f);
    rect.m_anchorMax = Vec2_Set(0.0f, 0.0f);
    rect.m_offsetMin = Vec2_Set(0.0f, 200.0f);
    rect.m_offsetMax = Vec2_Set(80.0f, 280.0f);
   ...
   // Compteur du nombre de coeur
    ...
    rect.m_anchorMin = Vec2_Set(0.0f, 0.0f);
    rect.m_anchorMax = Vec2_Set(0.0f, 0.0f);
    rect.m_offsetMin = Vec2_Set(100.0f, 200.0f);
    rect.m_offsetMax = Vec2_Set(300.0f, 280.0f);
...
void LevelHeader_VM_Update(void *self)
{
    ...
    //Update de l'affichage du nombre de luciole et de life

    count = Player_GetFireflyCount(player);
    sprintf(str, "%d", count);
    Text_SetString(panel->m_fireflyCountText, str);

    lcount = Player_GetLifeCount(player);
    sprintf(str, "%d", lcount);
    Text_SetString(panel->m_LifeCountText, str);

   hcount = Player_GetHeartCount(player);
    sprintf(str, "%d", hcount);
